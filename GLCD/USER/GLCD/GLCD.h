...
*/
#define Set_Cs        GPIOA->ODR  |= ( 1<<12 );
#define Clr_Cs        GPIOA->ODR  &= ~( 1<<12 );

#define Set_Rs        GPIOA->ODR  |= ( 1<<13 );
#define Clr_Rs        GPIOA->ODR  &= ~( 1<<13 );

#define Set_nWr       GPIOA->ODR  |= ( 1<<14 );
#define Clr_nWr       GPIOA->ODR  &= ~( 1<<14 );

#define Set_nRd       GPIOA->ODR  |= ( 1<<15 );
#define Clr_nRd       GPIOA->ODR  &= ~( 1<<15 );
